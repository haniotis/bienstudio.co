// Bien logomark (the "B" monogram). Uses fill="currentColor" so it follows the
// current text color. Size via `className`. Pass `decorative` when it's purely
// visual (e.g. the faint hero mark) so screen readers skip it.
export function Logomark({
  ...
  return (
    <svg
      ...
      aria-label={decorative ? undefined : "Bien"}
